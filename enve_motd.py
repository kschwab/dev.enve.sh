...
def enve_motd() -> str:
    ...
    if os.path.exists(home_dir):
        disk_space.append(('~', subprocess.run("flatpak-spawn --host df -H --output=avail %s | tail -n+2" % home_dir,
                                               shell=True, capture_output=True, text=True).stdout.strip()))
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\e[0m \~| \e[32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    enve_motd_stats = \
"""
┃\e[0m     CPU \e[32m┃\e[0m {: <53} \e[32m┃\e[0m FREE SPACE \e[32m┃
┃\e[0m     RAM \e[32m┃\e[0m {: <53} \e[32m┃\e[0m {: <2} {: >7} \e[32m┃
┃\e[0m  UPTIME \e[32m┃\e[0m {: <53} \e[32m┃\e[0m {: <2} {: >7} \e[32m┃
┃\e[0m FLATPAK \e[32m┃\e[0m {: <53} \e[32m┃\e[0m {: <2} {: >7} \e[32m┃\e[0m""".format(
